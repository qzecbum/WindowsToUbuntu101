...
##### Minimize Fix
- Once you minimize a windows application, you cant maximize it again in KDE but there is a fix
1. Open **KDE Settings**
2. Select **Window Management** on the left Panel
3. Select **Window Rules** in the sub panel
4. Click **Add New at the bottom**
- **Fill in the following**
- DESCRIPTION: "freerdp"
- WINDOWS CLASS: "extact match: xfreerdp"
- MATCH WHOLE CLASS: "no"
- WINDOW TYPES: "All Selected"
1. **Now add the Properties**
- Select ``Add Property``
- Search and select ``Minimized``
- Change the ``Apply Initially`` to ``Forced`` **and on the right select** ``No``.
- **Click Apply on the bottom and restart the computer**.


##### Shutdown Fix
- One downside to WinApps is it adds at least 2 minutes to the shutdown time, but there is  a fix 
